(function(){
  ...
  const leaveRows=[
    ...
    {leaveId:'LEV-002',employeeId:'E004',employeeName:'อรทัย ขยัน',nickname:'อร',leaveType:'REQUEST_OFF',leaveTypeLabel:'ขอเลือกวันหยุด',startDate:iso(plus(nextMon,4)),endDate:iso(plus(nextMon,4)),duration:'FULL_DAY',reason:'นัดหมายครอบครัว',status:'APPROVED',branchCode:'KORAT',departmentCode:'KITCHEN',shiftCode:'DAY',quotaStatus:'FULL',scheduleConflict:''}
  ];
